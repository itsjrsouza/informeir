...
def gerar_pdf(dados, output_path):
    ...
    add_section('2. PESSOA FÍSICA BENEFICIÁRIA DOS RENDIMENTOS',
                [['CPF', 'Nome Completo'],
                 ...
                 ['Natureza do Rendimento: Assalariado', '']],
                [50*mm, 120*mm])
