...
const REND_FIELDS = [
  ...
  // Seção 4
  {key:"parcelaIsenta65", label:"01 - Aposentadoria/pensão/reforma isenta (65+)", sec:4},
  {key:"parcelaIsenta13", label:"02 - Aposentadoria/pensão/reforma isenta (13º)", sec:4},
  {key:"diariasAjudas", label:"03 - Diárias e ajudas de custo", sec:4},
  {key:"molestiaGrave", label:"04 - Aposentadoria/pensão/reforma (moléstia grave ou acidente)", sec:4},
  {key:"lucrosDividendos", label:"05 - Lucros e dividendos (desde 1996)", sec:4},
  {key:"prolaboreIsento", label:"06 - Valores a sócio/titular (exceto pró-labore, aluguéis e serviços)", sec:4},
  {key:"indenizacoes", label:"07 - Indenizações trabalhistas (rescisão, PDV, acidente)", sec:4},
  {key:"outrosIsentos", label:"08 - Outros rendimentos isentos", sec:4},
  // Seção 5
  ...
  {key:"rraTributaveis", label:"01 - Rendimentos tributáveis (férias e 13º)", sec:6, tipo:"moeda"},
  {key:"rraDespesasJudiciais", label:"02 - Despesas judiciais", sec:6, tipo:"moeda"},
