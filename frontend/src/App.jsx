...
const REND_FIELDS = [
  ...
  {key:"molestiaGrave", label:"03 - Aposentadoria/pensão/reforma (moléstia grave ou acidente)", sec:4},
  {key:"lucrosDividendos", label:"04 - Lucros e dividendos (desde 1996)", sec:4},
  {key:"prolaboreIsento", label:"05 - Valores a sócio/titular (exceto pró-labore, aluguéis e serviços)", sec:4},
  {key:"indenizacoes", label:"06 - Indenizações trabalhistas (rescisão, PDV, acidente)", sec:4},
